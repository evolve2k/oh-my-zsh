...
`curl -L https://raw.github.com/evolve2k/oh-my-zsh/master/tools/install.sh | sh`

#### via wget

`wget https://raw.github.com/evolve2k/oh-my-zsh/master/tools/install.sh -O - | sh`

## Using Oh My Zsh

### Plugins

Oh My Zsh comes with a shit load of plugins to take advantage of. You can take a look in the [plugins](https://github.com/evolve2k/oh-my-zsh/tree/master/plugins) directory and/or the [wiki](https://github.com/robbyrussell/oh-my-zsh/wiki/Plugins) to see what's currently available.
